...
- **Budget tiers** (green 0-30% / yellow 30-60% / orange 60-80% / red 80%+) computed from `usage.total_tokens / getModelContextWindow(model)`. Window auto-detected for GLM-5 (1M), DeepSeek V3 (200K), Codex [1m] suffix, etc.
...
- **README.md** describes the old Python multi-agent GAN architecture — do not trust it for current architecture. AGENTS.md is authoritative.
